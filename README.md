...
* templates/config samples (optional)
...
## Suggested “minimum” files for a clean public repo

* `README.md`
* `requirements.txt`
* `run_all.py`
* your scripts in root
* a small sample universe file (optional), e.g. `data/universe_biopharma.sample.csv`

---

If you want, paste your current `run_all.py` (or `_all.py`) content and I’ll:

* align this README to the **exact** script order you’re using,
* add a `--fresh` option if you want,
* and ensure the pipeline produces all expected outputs reliably.
